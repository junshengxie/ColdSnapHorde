...
public class NetherColdSnapSnowballerModel<T extends GenericHordeMember> extends EntityModel<T> {
    ...
    public static final ModelLayerLocation NCOLDSNAPSNOWBALLER = new ModelLayerLocation(new ResourceLocation("coldsnaphorde", "nethercoldsnapsnowballermodel"), "main");
