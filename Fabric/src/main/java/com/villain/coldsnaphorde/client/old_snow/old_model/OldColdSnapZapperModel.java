package com.villain.coldsnaphorde.client.old_snow.old_model;// Made with Blockbench 4.1.1
...
public class OldColdSnapZapperModel<T extends Entity> extends EntityModel<T> {
	// This layer location should be baked with EntityRendererProvider.Context in the entity renderer and passed into this model's constructor
	public static final ModelLayerLocation LAYER_LOCATION = new ModelLayerLocation(new ResourceLocation("coldsnaphorde", "oldcoldsnapzappermodel"), "main");
	...
	public OldColdSnapZapperModel(ModelPart root) {
