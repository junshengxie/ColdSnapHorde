...
import com.villain.coldsnaphorde.mixin.AxoltolAccessor;
import com.villain.coldsnaphorde.mixin.EntityAccessor;
import com.villain.coldsnaphorde.mixin.GoatAccessor;
...
import static com.villain.coldsnaphorde.CommonColdSnapHorde.*;
...
public class Present extends Item {
    ...
    public InteractionResultHolder<ItemStack> use(Level worldIn, Player playerIn, InteractionHand handIn) {
        ...
        if(playerIn.getServer() != null) {
            giveAdvancement((ServerPlayer) playerIn, playerIn.getServer(), new ResourceLocation(Constants.MOD_ID, "unboxing"));
        }
