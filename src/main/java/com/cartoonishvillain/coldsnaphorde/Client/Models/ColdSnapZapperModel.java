...
//
//public class ColdSnapZapperModel<C extends Monster> extends EntityModel<ColdSnapZapper> {
...
//
//    @Override
//    public void setupAnim(ColdSnapZapper entityIn, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
