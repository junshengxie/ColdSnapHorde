package com.cartoonishvillain.coldsnaphorde.Client.Models.EndModel;// Made with Blockbench 3.9.2
...
public class EndColdSnapSnowballerModel<C extends GenericHordeMember> extends EntityModel<ColdSnapSnowballer> {
	...
	public EndColdSnapSnowballerModel() {
		textureWidth = 128;
		textureHeight = 128;
		...
		body.setTextureOffset(0, 93).addBox(-8.0F, -23.0F, -8.0F, 16.0F, 16.0F, 16.0F, -2.5F, false);
