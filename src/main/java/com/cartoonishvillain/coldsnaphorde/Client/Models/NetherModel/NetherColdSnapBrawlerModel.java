...
public class NetherColdSnapBrawlerModel<C extends GenericHordeMember> extends EntityModel<ColdSnapBrawler> {
	...
	public NetherColdSnapBrawlerModel() {
		...
		lowbody.setTextureOffset(51, 90).addBox(-6.0F, -12.0F, 2.25F, 12.0F, 12.0F, 12.0F, -0.5F, false);
		lowbody.setTextureOffset(0, 97).addBox(-6.0F, -10.17F, -6.0F, 12.0F, 12.0F, 12.0F, -0.5F, false);
		...
		left_hand.setRotationPoint(4.5F, -6.7F, 0.0F);
		...
		right_hand.setRotationPoint(-3.0F, -7.3F, 1.3F);
		...
		hat.setTextureOffset(31, 11).addBox(-4.05F, -6.5F, -4.0F, 8.0F, 6.0F, 8.0F, -0.48F, false);
	}
