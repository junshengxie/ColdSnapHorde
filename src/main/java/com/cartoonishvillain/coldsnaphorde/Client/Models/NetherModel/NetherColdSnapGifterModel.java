...
public class NetherColdSnapGifterModel<C extends GenericHordeMember> extends EntityModel<ColdSnapGifter> {
	...
	public NetherColdSnapGifterModel() {
		...
		bone4.setPos(0.0F, 24.5F, 0.0F);
		

		bone2 = new ModelRenderer(this);
		bone2.setPos(0.0F, -9.1F, 0.0F);
		bone4.addChild(bone2);
		setRotationAngle(bone2, 0.2559F, 0.056F, -0.1237F);
		

		head = new ModelRenderer(this);
		head.setPos(0.0F, -7.3F, -1.5F);
		bone2.addChild(head);
		setRotationAngle(head, -0.6545F, 0.0F, 0.0F);
		head.texOffs(40, 16).addBox(-4.0F, -8.0F, -4.0F, 8.0F, 8.0F, 8.0F, -0.5F, false);

		bone3 = new ModelRenderer(this);
		bone3.setPos(1.0F, -1.2F, 0.6F);
		head.addChild(bone3);
		setRotationAngle(bone3, 0.2355F, 0.3829F, 0.0894F);
		bone3.texOffs(0, 0).addBox(-0.95F, -4.05F, -4.45F, 1.0F, 1.0F, 1.0F, -0.05F, false);
		bone3.texOffs(4, 0).addBox(-0.95F, -4.05F, -5.35F, 1.0F, 1.0F, 1.0F, -0.05F, false);

		bone = new ModelRenderer(this);
		bone.setPos(-0.45F, -7.2F, -0.5F);
		head.addChild(bone);
		setRotationAngle(bone, -0.0859F, 0.0151F, 0.1739F);
		bone.texOffs(36, 0).addBox(-6.0F, -3.4F, -4.0F, 13.0F, 4.0F, 7.0F, -0.6F, false);

		bow1_r1 = new ModelRenderer(this);
		bow1_r1.setPos(0.5F, -2.8F, -0.5F);
		...
		left_hand.setPos(4.5F, -6.0F, 0.0F);
		bone2.addChild(left_hand);
		setRotationAngle(left_hand, 0.662F, 1.1366F, 0.6271F);
		left_hand.texOffs(48, 11).addBox(-0.9782F, -0.5F, -0.5005F, 12.0F, 2.0F, 2.0F, -0.5F, true);

		present = new ModelRenderer(this);
		present.setPos(9.8718F, 0.1F, 0.9995F);
		left_hand.addChild(present);
		

		base_r1 = new ModelRenderer(this);
		base_r1.setPos(0.6282F, -0.1F, -0.5F);
		present.addChild(base_r1);
		setRotationAngle(base_r1, 0.0F, 0.0F, 0.0436F);
		base_r1.texOffs(32, 46).addBox(-5.6282F, -2.903F, -2.5F, 11.0F, 3.0F, 5.0F, -0.099F, false);

		right_hand = new ModelRenderer(this);
		right_hand.setPos(-3.1F, -4.8F, 0.9F);
		bone2.addChild(right_hand);
		setRotationAngle(right_hand, 0.2943F, -0.6534F, -0.3822F);
		right_hand.texOffs(48, 11).addBox(-8.9F, 0.0F, -1.0F, 12.0F, 2.0F, 2.0F, -0.5F, false);
		...
		lowbody.setPos(0.0F, 0.0F, 0.0F);
		bone4.addChild(lowbody);
		lowbody.texOffs(12, 72).addBox(-6.0F, -10.17F, -6.0F, 12.0F, 12.0F, 12.0F, -0.5F, false);
		lowbody.texOffs(51, 92).addBox(-6.0F, -12.0F, 0.4F, 12.0F, 12.0F, 12.0F, -0.5F, false);
		lowbody.texOffs(0, 104).addBox(-6.0F, -12.0F, -6.0F, 12.0F, 12.0F, 12.0F, -0.5F, false);
	}
