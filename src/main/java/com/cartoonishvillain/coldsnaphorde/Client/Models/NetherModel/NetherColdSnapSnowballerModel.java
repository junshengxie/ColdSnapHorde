...
public class NetherColdSnapSnowballerModel<C extends GenericHordeMember> extends EntityModel<ColdSnapSnowballer> {
    ...
    public NetherColdSnapSnowballerModel() {
        ...
        lowbody.setTextureOffset(0, 36).addBox(-6.0F, -11.5F, -6.0F, 12.0F, 12.0F, 12.0F, -0.5F, false);
        lowbody.setTextureOffset(0, 104).addBox(-6.0F, -11.55F, -0.5F, 12.0F, 12.0F, 12.0F, -0.5F, false);
        lowbody.setTextureOffset(50, 36).addBox(-6.0F, -9.7F, -6.0F, 12.0F, 12.0F, 12.0F, -0.5F, false);

        upper = new ModelRenderer(this);
        upper.setRotationPoint(-3.0F, 14.8F, -1.0F);
        setRotationAngle(upper, -0.0436F, 0.0F, 0.3054F);


        head = new ModelRenderer(this);
        head.setRotationPoint(3.0F, -9.4F, -0.2F);
        upper.addChild(head);
        ...
        hat.setTextureOffset(31, 11).addBox(-4.0F, -6.5F, -4.0F, 8.0F, 6.0F, 8.0F, -0.5F, false);

        body = new ModelRenderer(this);
        body.setRotationPoint(3.0F, 0.5F, 1.0F);
        upper.addChild(body);
        body.setTextureOffset(0, 16).addBox(-5.0F, -10.0F, -5.0F, 10.0F, 10.0F, 10.0F, -0.5F, false);

        cube_r1 = new ModelRenderer(this);
        cube_r1.setRotationPoint(0.0F, -9.5F, 0.0F);
        body.addChild(cube_r1);
        setRotationAngle(cube_r1, 0.48F, 0.0F, -0.48F);
        cube_r1.setTextureOffset(0, 61).addBox(-8.0F, -13.5F, -8.0F, 16.0F, 16.0F, 16.0F, -2.5F, false);

        left_hand = new ModelRenderer(this);
        left_hand.setRotationPoint(4.5F, -6.8F, 0.0F);
        body.addChild(left_hand);
        setRotationAngle(left_hand, 0.0F, 1.0472F, 0.7854F);


        left_hand_r1 = new ModelRenderer(this);
        left_hand_r1.setRotationPoint(0.0121F, 0.005F, 0.0F);
        left_hand.addChild(left_hand_r1);
        setRotationAngle(left_hand_r1, 0.0F, 0.0F, -0.6109F);
        left_hand_r1.setTextureOffset(32, 0).addBox(-0.8F, -0.5F, -1.0F, 12.0F, 2.0F, 2.0F, -0.5F, false);

        right_hand = new ModelRenderer(this);
        right_hand.setRotationPoint(-4.5F, -6.8F, 0.0F);
        body.addChild(right_hand);
        setRotationAngle(right_hand, 0.0F, 0.0F, -0.7854F);
        right_hand.setTextureOffset(32, 0).addBox(-12.7121F, 5.505F, -1.0F, 12.0F, 2.0F, 2.0F, -0.5F, false);
    }
