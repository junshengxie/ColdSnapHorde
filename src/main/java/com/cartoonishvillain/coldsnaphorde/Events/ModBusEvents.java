...
public class ModBusEvents {
    ...
    public static void onEntityAttributeCreation(final EntityAttributeCreationEvent event){
        ...
        event.put(Register.COLDSNAPGIFTER.get(), ColdSnapSnowballer.customAttributes().build());
        ...
        event.put(Register.PCOLDSNAPGIFTER.get(), ColdSnapSnowballer.customAttributes().build());
        ...
        event.put(Register.NCOLDSNAPGIFTER.get(), ColdSnapSnowballer.customAttributes().build());
        ...
        event.put(Register.ECOLDSNAPGIFTER.get(), ColdSnapSnowballer.customAttributes().build());
