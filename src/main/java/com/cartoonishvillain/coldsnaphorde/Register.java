...
public class Register {
    ...
    public static final RegistryObject<EntityType<StandardHorde.StandardGifter>> COLDSNAPGIFTER = ENTITY_TYPES.register("coldsnapgifter", () -> EntityType.Builder.of(StandardHorde.StandardGifter::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "coldsnapgifter").toString()));
    public static final RegistryObject<EntityType<StandardHorde.StandardGunner>> COLDSNAPGUNNER = ENTITY_TYPES.register("coldsnapgunner", () -> EntityType.Builder.of(StandardHorde.StandardGunner::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "coldsnapgunner").toString()));
    public static final RegistryObject<EntityType<StandardHorde.StandardStabber>> COLDSNAPSTABBER = ENTITY_TYPES.register("coldsnapstabber", () -> EntityType.Builder.of(StandardHorde.StandardStabber::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "coldsnapstabber").toString()));
    public static final RegistryObject<EntityType<StandardHorde.StandardSnowballer>> COLDSNAPSNOWBALLER = ENTITY_TYPES.register("coldsnapsnowballer", () -> EntityType.Builder.of(StandardHorde.StandardSnowballer::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "coldsnapsnowballer").toString()));
    public static final RegistryObject<EntityType<StandardHorde.StandardZapper>> COLDSNAPZAPPER = ENTITY_TYPES.register("coldsnapzapper", () -> EntityType.Builder.of(StandardHorde.StandardZapper::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "coldsnapzapper").toString()));
    public static final RegistryObject<EntityType<StandardHorde.StandardBrawler>> COLDSNAPBRAWLER = ENTITY_TYPES.register("coldsnapbrawler", () -> EntityType.Builder.of(StandardHorde.StandardBrawler::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "coldsnapbrawler").toString()));

    public static final RegistryObject<EntityType<NetherHorde.NetherGifter>> NCOLDSNAPGIFTER = ENTITY_TYPES.register("ncoldsnapgifter", () -> EntityType.Builder.of(NetherHorde.NetherGifter::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ncoldsnapgifter").toString()));
    public static final RegistryObject<EntityType<NetherHorde.NetherGunner>> NCOLDSNAPGUNNER = ENTITY_TYPES.register("ncoldsnapgunner", () -> EntityType.Builder.of(NetherHorde.NetherGunner::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ncoldsnapgunner").toString()));
    public static final RegistryObject<EntityType<NetherHorde.NetherStabber>> NCOLDSNAPSTABBER = ENTITY_TYPES.register("ncoldsnapstabber", () -> EntityType.Builder.of(NetherHorde.NetherStabber::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ncoldsnapstabber").toString()));
    public static final RegistryObject<EntityType<NetherHorde.NetherSnowballer>> NCOLDSNAPSNOWBALLER = ENTITY_TYPES.register("ncoldsnapsnowballer", () -> EntityType.Builder.of(NetherHorde.NetherSnowballer::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ncoldsnapsnowballer").toString()));
    public static final RegistryObject<EntityType<NetherHorde.NetherZapper>> NCOLDSNAPZAPPER = ENTITY_TYPES.register("ncoldsnapzapper", () -> EntityType.Builder.of(NetherHorde.NetherZapper::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ncoldsnapzapper").toString()));
    public static final RegistryObject<EntityType<NetherHorde.NetherBrawler>> NCOLDSNAPBRAWLER = ENTITY_TYPES.register("ncoldsnapbrawler", () -> EntityType.Builder.of(NetherHorde.NetherBrawler::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ncoldsnapbrawler").toString()));

    public static final RegistryObject<EntityType<EndHorde.EndGifter>> ECOLDSNAPGIFTER = ENTITY_TYPES.register("ecoldsnapgifter", () -> EntityType.Builder.of(EndHorde.EndGifter::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ecoldsnapgifter").toString()));
    public static final RegistryObject<EntityType<EndHorde.EndGunner>> ECOLDSNAPGUNNER = ENTITY_TYPES.register("ecoldsnapgunner", () -> EntityType.Builder.of(EndHorde.EndGunner::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ecoldsnapgunner").toString()));
    public static final RegistryObject<EntityType<EndHorde.EndStabber>> ECOLDSNAPSTABBER = ENTITY_TYPES.register("ecoldsnapstabber", () -> EntityType.Builder.of(EndHorde.EndStabber::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ecoldsnapstabber").toString()));
    public static final RegistryObject<EntityType<EndHorde.EndSnowballer>> ECOLDSNAPSNOWBALLER = ENTITY_TYPES.register("ecoldsnapsnowballer", () -> EntityType.Builder.of(EndHorde.EndSnowballer::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ecoldsnapsnowballer").toString()));
    public static final RegistryObject<EntityType<EndHorde.EndZapper>> ECOLDSNAPZAPPER = ENTITY_TYPES.register("ecoldsnapzapper", () -> EntityType.Builder.of(EndHorde.EndZapper::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ecoldsnapzapper").toString()));
    public static final RegistryObject<EntityType<EndHorde.EndBrawler>> ECOLDSNAPBRAWLER = ENTITY_TYPES.register("ecoldsnapbrawler", () -> EntityType.Builder.of(EndHorde.EndBrawler::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "ecoldsnapbrawler").toString()));

    public static final RegistryObject<EntityType<PlagueHorde.PlagueGifter>> PCOLDSNAPGIFTER = ENTITY_TYPES.register("pcoldsnapgifter", () -> EntityType.Builder.of(PlagueHorde.PlagueGifter::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "pcoldsnapgifter").toString()));
    public static final RegistryObject<EntityType<PlagueHorde.PlagueGunner>> PCOLDSNAPGUNNER = ENTITY_TYPES.register("pcoldsnapgunner", () -> EntityType.Builder.of(PlagueHorde.PlagueGunner::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "pcoldsnapgunner").toString()));
    public static final RegistryObject<EntityType<PlagueHorde.PlagueStabber>> PCOLDSNAPSTABBER = ENTITY_TYPES.register("pcoldsnapstabber", () -> EntityType.Builder.of(PlagueHorde.PlagueStabber::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "pcoldsnapstabber").toString()));
    public static final RegistryObject<EntityType<PlagueHorde.PlagueSnowballer>> PCOLDSNAPSNOWBALLER = ENTITY_TYPES.register("pcoldsnapsnowballer", () -> EntityType.Builder.of(PlagueHorde.PlagueSnowballer::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "pcoldsnapsnowballer").toString()));
    public static final RegistryObject<EntityType<PlagueHorde.PlagueZapper>> PCOLDSNAPZAPPER = ENTITY_TYPES.register("pcoldsnapzapper", () -> EntityType.Builder.of(PlagueHorde.PlagueZapper::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "pcoldsnapzapper").toString()));
    public static final RegistryObject<EntityType<PlagueHorde.PlagueBrawler>> PCOLDSNAPBRAWLER = ENTITY_TYPES.register("pcoldsnapbrawler", () -> EntityType.Builder.of(PlagueHorde.PlagueBrawler::new, EntityClassification.MONSTER).sized(0.6f, 1.95f).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "pcoldsnapbrawler").toString()));
    ...
    public static final RegistryObject<EntityType<ThrownChorusEntity>> THROWNCHORUSPROJECTILE = ENTITY_TYPES.register("thrownchorusprojectile", () -> EntityType.Builder.<ThrownChorusEntity>of(ThrownChorusEntity::new, EntityClassification.MISC).sized(0.25f, 0.25f).clientTrackingRange(4).updateInterval(10).build(new ResourceLocation(ColdSnapHorde.MOD_ID, "thrownchorusprojectile").toString()));
    ...
    public static final RegistryObject<Block> SLUSH = BLOCKS.register("slush", () -> new SlushBlock(AbstractBlock.Properties.of(Material.TOP_SNOW).strength(0).sound(SoundType.SNOW)));
