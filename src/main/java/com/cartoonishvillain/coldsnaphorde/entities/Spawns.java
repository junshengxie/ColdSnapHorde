...
public class Spawns {
    ...
    public static void SnowmanSpawner(BiomeLoadingEvent event){
        ...
        MobSpawnSettings.SpawnerData spawners6 = new MobSpawnSettings.SpawnerData(Register.COLDSNAPCOW.get(), ColdSnapHorde.cconfig.SNOWCOW.get(),2, 4);
    ...
    public static void PlacementManager(){
        if (!ColdSnapHorde.cconfig.PROGRESSIVESPAWNS.get()) {
    ...
    public static boolean doMobSpawn(EntityType<? extends Monster> p_33018_, ServerLevelAccessor p_33019_, MobSpawnType p_33020_, BlockPos p_33021_, Random p_33022_, int level) {
        if (ColdSnapHorde.hordeDataManager.getHighestLevelBeaten() >= level) {
