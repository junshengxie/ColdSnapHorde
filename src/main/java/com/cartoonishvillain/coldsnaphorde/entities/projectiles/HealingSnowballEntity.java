...
public class HealingSnowballEntity extends ThrowableItemProjectile {
    ...
    protected Item getDefaultItem() {
        ...
        switch (ordinal) {
            default -> {
                return Register.LESSERHEALINGBALL.get();
            }
            case 1 ->  {
                return Register.HEALINGBALL.get();
            }
            case 2 -> {
                return Register.GREATERHEALINGBALL.get();
            }
        }
    }
    ...
    public ItemStack getItem() {
        ...
        switch (ordinal) {
            default -> {
                return new ItemStack(Register.LESSERHEALINGBALL.get());
            }
            case 1 ->  {
                return new ItemStack(Register.HEALINGBALL.get());
            }
            case 2 -> {
                return new ItemStack(Register.GREATERHEALINGBALL.get());
            }
        }
    }
}
